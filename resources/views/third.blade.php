...
<section>
                <div class="main">
                    <div class="title">
                          <h3 class="title-content">மூன்றாம் ஆண்டு விண்ணப்பம்</h3>
                    </div>
                    <div class="sub-title">
...
<section id="section-form" class="section-form">
    <div class="form-header">
        ...
        <form method="post" action="{{route('third')}}" enctype="multipart/form-data">
            @csrf
    ...
    <div class="father-name">
        ...
        <div class="submit">
            ...
            <div class="submit-list">
                <input type="hidden" name="yr" class="text" value="third">
            </div>
            <div class="submit-list">
